...
import { e as oilsWithFormat } from "./router-hF0FH8D9.js";
...
const availableScents = [{
  ...
  notes: "Cherry • Rose • Amber"
}];
function DryBodyOilPage() {
  const items = oilsWithFormat("dry-body-oil");
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(PageHeader, { eyebrow: "Dry Body Oil", title: /* @__PURE__ */ jsxs(Fragment, { children: [
      "Lightweight. Silky.",
      " ",
      /* @__PURE__ */ jsx("span", { className: "serif-italic text-gold", children: "Fast absorbing." })
    ...
    /* @__PURE__ */ jsx("section", { className: "bg-ivory", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-7xl px-5 md:px-10 py-20 md:py-28", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-12", children: items.map((p, i) => /* @__PURE__ */ jsx(DryBodyOilCard, { p, delay: i * 0.06 }, p.id)) })
    ] }) })
  ] });
}
function DryBodyOilCard({
  p,
  delay
}) {
