...
function BodyButterPage() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(PageHeader, { eyebrow: "Body Butter", title: /* @__PURE__ */ jsxs(Fragment, { children: [
      "Richer, deeper",
      " ",
    ...
    /* @__PURE__ */ jsx("section", { className: "bg-ivory", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-7xl px-5 md:px-10 py-20 md:py-28", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-12", children: items.map((p, i) => /* @__PURE__ */ jsx(BodyButterCard, { p, delay: i * 0.06 }, p.id)) })
    ] }) })
  ] });
}
function BodyButterCard({
  p,
  delay
}) {
