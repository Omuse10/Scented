...
const availableScents = [{
  ...
  name: "Cipher",
  notes: "Pineapple • Woods • Amber"
}, {
  name: "Tangier Twilight",
  notes: "Tobacco • Woods • Amber"
}];
function BodyLotionPage() {
  const items = oilsWithFormat("body-lotion");
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(PageHeader, { eyebrow: "Body Lotion", title: /* @__PURE__ */ jsxs(Fragment, { children: [
      "Lightweight daily",
      " ",
    ...
    /* @__PURE__ */ jsx("section", { className: "bg-ivory", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-7xl px-5 md:px-10 py-20 md:py-28", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-12", children: items.map((p, i) => /* @__PURE__ */ jsx(BodyLotionCard, { p, delay: i * 0.06 }, p.id)) })
    ] }) })
  ] });
}
function BodyLotionCard({
  p,
  delay
}) {
